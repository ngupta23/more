...
def plot_parallel_coordinates(data, by, sample=True, frac=1.0, normalize=True
                              ,figsize = (8,6),legend_title=None
                              ,legend_loc='best',legend_anchor=(1,1),xrot = 0, random_state=1):
    """
    ...
    if (legend_title == None):
        legend_title = by
    plt.legend(title=legend_title, loc=legend_loc, fancybox=True, bbox_to_anchor=legend_anchor)
